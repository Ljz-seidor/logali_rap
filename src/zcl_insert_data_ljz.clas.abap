CLASS zcl_insert_data_ljz DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcl_insert_data_ljz IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA: lt_travel   TYPE TABLE OF ztravel_ljz,
          lt_booking  TYPE TABLE OF zbooking_ljz,
          lt_book_sup TYPE TABLE OF zbooksuppl_ljz.
    ...
    INSERT: ztravel_ljz    FROM TABLE @lt_travel,
            zbooking_ljz   FROM TABLE @lt_booking,
            zbooksuppl_ljz FROM TABLE @lt_book_sup.
